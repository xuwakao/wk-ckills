...
3. PHASED DEVELOPMENT: Follow META-PHASE A→B→C→D. CRITICAL — every review must produce a named artifact:
   ...
   - Phase Review (C.3): write "### Review: Phase N" in progress with expected-vs-actual table, evidence, and PASS/FAIL verdict. A phase without this entry CANNOT be marked COMPLETE.
